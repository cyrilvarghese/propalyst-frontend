...
export function SearchBar({
    ...
    return (
        <div className="flex items-center gap-2 w-full md:w-auto">
            {/* Submit to database - Desktop only */}
            <a
                href="https://chat.whatsapp.com/J827YjNq8RU5Zwf0NWhXHY?mode=hqrt1"
                target="_blank"
                rel="noopener noreferrer"
                className="hidden lg:flex items-center gap-3 mr-4 pr-4 border-r border-slate-300 hover:opacity-80 transition-opacity group"
            >
                <div className="h-8 w-8 rounded-full bg-slate-100 flex items-center justify-center shrink-0 group-hover:bg-slate-200 transition-colors">
                ...
                <div className="flex flex-col">
                    <span className="text-sm font-semibold text-slate-800">Add your listing</span>
                    <span className="text-xs text-slate-500">Join our WhatsApp group to submit</span>
                </div>
            </a>
